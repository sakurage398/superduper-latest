...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        if (!empty($memberData['picture'])) {
            $memberData['picture'] = formatPictureForDisplay($memberData['picture'], 'student');
        }
    } else {
        ...
        if ($result->num_rows > 0) {
            ...
            // Format picture for display
            if (!empty($memberData['picture'])) {
                $memberData['picture'] = formatPictureForDisplay($memberData['picture'], 'faculty');
            }
        } else {
            ...
            if ($result->num_rows > 0) {
                ...
                // Format picture for display
                if (!empty($memberData['picture'])) {
                    $memberData['picture'] = formatPictureForDisplay($memberData['picture'], 'staff');
                }
            }
        }
    }
